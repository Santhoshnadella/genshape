...
namespace Leap71.HabitatExample
{
    public class InflatableHabitat
    {
        ...
        public InflatableHabitat(
            float fDeployment,
            float fStowedRadius = 30f,
            float fDeployedRadius = 50f,
            float fStowedHeight = 5f,
            float fDeployedHeight = 60f,
            float fWallThickness = 2f,
            int nTiers = 5,
            int nSegments = 12)
        {
            m_fDeployment = Math.Clamp(fDeployment, 0f, 1f);
            m_fStowedRadius = fStowedRadius;
            m_fDeployedRadius = fDeployedRadius;
            m_fStowedHeight = fStowedHeight;
            m_fDeployedHeight = fDeployedHeight;
