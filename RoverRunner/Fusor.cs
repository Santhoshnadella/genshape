...
namespace Leap71.FusorExample
{
    public class Fusor
    {
        ...
        public Fusor(
            float fChamOuterRad = 80f,
            float fChamWallThick = 5f,
            float fOuterGridRad = 50f,
            float fInnerGridRad = 15f,
            float fPortRad = 15f,
            float fPortLength = 40f)
        {
            m_fChamOuterRad = fChamOuterRad;
            m_fChamWallThick = fChamWallThick;
            m_fOuterGridRad = fOuterGridRad;
            m_fInnerGridRad = fInnerGridRad;
            m_fPortRad = fPortRad;
            m_fPortLength = fPortLength;
        }
